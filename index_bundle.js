(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["socialtab"] = factory();
	else
		root["socialtab"] = factory();
...
var _Table = _interopRequireDefault(__webpack_require__(27));
...
var table = [{
  ...
  rows: [{
    ...
    type: 'field',
    content: 'Column 2 - Row 4'
  }, {
    type: 'field',
    content: 'Column 2 - Row 5'
  }]
}, {
  column_id: 3,
  rows: [{
    ...
    type: 'field',
    content: 'Column 3 - Row 4'
  }, {
    type: 'field',
    content: 'Column 3 - Row 5'
  }]
}, {
  column_id: 4,
  rows: [{
    ...
    type: 'field',
    content: 'Column 4 - Row 1'
  }, {
    type: 'field',
    content: 'Column 4 - Row 2'
  }, {
    type: 'field',
    content: 'Column 4 - Row 3'
  }, {
    type: 'field',
    content: 'Column 4 - Row 4'
  }, {
    type: 'field',
    content: 'Column 4 - Row 5'
  }]
}];
var table_2 = [{
  type: 'header',
...
function (_Component) {
  ...
  function Table(props) {
    ...
    _this = _possibleConstructorReturn(this, (Table.__proto__ || Object.getPrototypeOf(Table)).call(this, props));
    Object.defineProperty(_assertThisInitialized(_this), "sort", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(field) {
        var table = _this.state.table.slice(1, _this.state.table.length);
        ...
        table.unshift(_this.state.table[0]);
